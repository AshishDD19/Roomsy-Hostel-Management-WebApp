...
<body>
    ...
    <div class="container">
        <a href="home.html" class="symbol"><i class="fa-solid fa-circle-xmark"></i></a>
      <div class="logo">
            <h1 id="txt1">Admin Registration</h1>
            <!-- <h1 id="txt2">Registration</h1> -->
        </div> 

        <div class="btn1">
        	<button id="signup">Admin Signup</button>
            <a href="signup.jsp"><button id="login">Resident Signup</button></a>
        ...
        <form action="adminSignup" method="post">
            <table class="details">
                <tr>
                    ...
                    <td><input type="text" name="name" required id="txtbox"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="tel" name="phone" id="txtbox"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="password" name="confirm" required id="txtbox"></td>
                </tr>
            ...
            <div class="txt">
                ...
                <p>Already have an account? <a href="adminLogin.jsp">Click here</a> to Login</p>
            </div>
