...
<body>
    ...
    <div class="container">
      ...
      <div class="logo">
            <h1 id="txt1">Resident Registration</h1>
            <!-- <h1 id="txt2">Registration</h1> -->
        </div> 

        <div class="btn1">
            <a href="adminSignup.jsp"><button id="login">Admin Signup</button></a>
            <button id="signup">Resident Signup</button>
        </div>
        ...
        <form action="signup" method="post">
            <table class="details">
                ...
                <tr>
                    ...
                    <td><input type="tel" name="phone" id="txtbox" maxlength="10"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="date" name="dob" required id="date"></td>
                </tr>
                <tr>
