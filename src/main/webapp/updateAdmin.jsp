...
<body>
	...
	<div class="container">
		<a href="adminProfile.jsp" class="symbol"><i
		...
		<form action="updateAdmin" method="post">
			<table class="details">
				...
				<td><input type="text" name="name" required id="txtbox"
					value="<%=a.getUsername()%>"></td>
				</tr>
				<tr>
					<td><label>Mail ID: </label></td>
					<td><input type="email" name="mail" required id="txtbox"
						value="<%=a.getEmail()%>"></td>
				</tr>

				<tr>
					<td><label>Phone number: </label></td>
					<td><input type="tel" name="phone" id="txtbox"
						value="<%=a.getPhone()%>"></td>
				</tr>
