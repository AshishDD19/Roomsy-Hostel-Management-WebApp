...
<head>
    ...
    <title>Update Resident Profile</title>
...
<body>
    ...
    <div class="container">
        <a href="residentProfile.jsp" class="symbol"><i class="fa-solid fa-circle-xmark"></i></a>
        <div class="logo">
        ...
        <form action="updateResident" method="post">
                ...
                <tr>
                    ...
                    <td><input type="text" name="name" required id="txtbox" value="<%=r.getName()%>"></td>
                </tr>
                <tr>
                    <td><label>Mail ID: </label></td>
                    <td><input type="email" name="mail" required id="txtbox" value="<%=r.getEmail()%>"></td>
                </tr>

                <tr>
                    <td><label>Phone number: </label></td>
                    <td><input type="tel" name="phone" id="txtbox" value="<%=r.getPhone()%>"></td>
                </tr>
                <tr>
                    <td><label>Gender: </label></td>
                    <td>
                        <input type="text" name="gender" value="<%=r.getGender() %>"  id="txtbox">
                    </td>
                </tr>
                <tr>
                    <td><label>Date Of Birth:</label></td>
                    <td><input type="date" name="dob" required id="date" value="<%=r.getDob()%>"></td>
                </tr>
                <tr>
                    <td><label>Address:</label></td>
                    <td><input type="text" name="address" id="address" value="<%=r.getAddress()%>"></td>
                </tr>
